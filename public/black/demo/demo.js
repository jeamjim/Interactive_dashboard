  ...
  initDashboardPageCharts: function() {
    ...
    var config = {
      ...
      options: {
        ...
        tooltips: { mode: "nearest", intersect: 0, position: "nearest" },
        responsive: true,
        scales: {
          yAxes: [{ ticks: { suggestedMin: 60, suggestedMax: 125, fontColor: "#9a9a9a" } }],
          xAxes: [{ ticks: { fontColor: "#9a9a9a" } }]
        }
      }
    };
    var myChartData = new Chart(ctxBig, config);

    var ctxPie = document.getElementById("chartLineGreen").getContext("2d");
    var myPieChart = new Chart(ctxPie, {
      type: 'pie',
      data: {
        labels: ['Apples', 'Bananas', 'Cherries', 'Dates'],
        datasets: [{
          backgroundColor: ['#00f2c3', '#e14eca', '#1f8ef1', '#ff8d72'],
          data: [120, 90, 70, 50]
        }]
      },
      options: {
    ...
    gradientStrokeCountry.addColorStop(0, 'rgba(29,140,248,0)');

    var myCountryChart = new Chart(ctxCountry, {
      type: 'bar',
      data: {
      ...
      options: {
        ...
        responsive: true,
        scales: {
          yAxes: [{ ticks: { suggestedMin: 20, suggestedMax: 120, fontColor: "#9e9e9e" } }],
          xAxes: [{ ticks: { fontColor: "#9e9e9e" } }]
        }
      }
    });
},
